...
import { CirclePlay, ChartPie, CircleUserRound, FolderDot, SquareCheck, Puzzle, Cat, Trash2 } from 'lucide-react';
    ...
    return (
      <div className='d-flex align-items-center p-11 mb-16 mt-4'>
        <Link to={PATH_DASHBOARD.app} className='d-flex align-items-center gap-10 select-none'>
          ...
          <span className='font-inter color-white fw-500 fs-23'>{BASE_NAME}</span>
        </Link>
      </div>
    )
  }
...
const ICONS = {
  ...
  metamask: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" id="Metamask-Icon--Streamline-Svg-Logos" height="18" width="18">
    ...
    items: [
      ...
      },
      {
        ...
        label: <Link to={PATH_DASHBOARD.wallet.list}>
          <SpanStyle className='d-block mt-0.5' label="Ví Web3" />
        </Link>,
        icon: ICONS.metamask,
      },
      {
