...
function Calendar({
  ...
  const _weekdayClassName = cn(
    "w-8 text-sm font-normal text-neutral-500 dark:text-neutral-400",
  ...
  const buttonRangeClassName =
    "bg-neutral-100 [&>button]:bg-neutral-900 [&>button]:text-neutral-50 [&>button]:hover:bg-neutral-900 [&>button]:hover:text-neutral-50 dark:bg-neutral-800 dark:[&>button]:bg-neutral-50 dark:[&>button]:text-neutral-900 dark:[&>button]:hover:bg-neutral-50 dark:[&>button]:hover:text-neutral-900"
  ...
  const _rangeMiddleClassName = cn(
    "bg-neutral-100 !text-foreground [&>button]:bg-transparent [&>button]:!text-foreground [&>button]:hover:bg-transparent [&>button]:hover:!text-foreground dark:bg-neutral-800",
    props.rangeMiddleClassName
  )
  const _selectedClassName = cn(
    "[&>button]:bg-neutral-900 [&>button]:text-neutral-50 [&>button]:hover:bg-neutral-900 [&>button]:hover:text-neutral-50 dark:[&>button]:bg-neutral-50 dark:[&>button]:text-neutral-900 dark:[&>button]:hover:bg-neutral-50 dark:[&>button]:hover:text-neutral-900",
    props.selectedClassName
  )
  const _todayClassName = cn(
    "[&>button]:bg-neutral-100 [&>button]:text-neutral-900 dark:[&>button]:bg-neutral-800 dark:[&>button]:text-neutral-50",
      ...
      {Array.from({ length: displayYears.to - displayYears.from + 1 }, (_, i) => {
        ...
        return (
          <Button
            key={i}
            className={cn(
              "h-7 w-full text-sm font-normal text-neutral-950 dark:text-neutral-50",
